        ...
        <Layout>
            ...
            <div className='container py-5'>
                ...
                <p>
                    ...
                    for the use of Helper's Website, located at helper.com.
                </p>

                <p>
                    By accessing this website we assume you accept these terms
                    and conditions. Do not continue to use Helper if you do not
                ...
                <p>
                    We employ the use of cookies. By accessing Helper, you
                    agreed to use cookies in agreement with the Helper's Privacy
                    Policy.{' '}
                </p>
                ...
                <p>
                    Unless otherwise stated, Helper and/or its licensors own the
                    intellectual property rights for all material on Helper. All
                    intellectual property rights are reserved. You may access
                    this from Helper for your own personal use subjected to
                    restrictions set in these terms and conditions.
                </p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Helper</li>
                    <li>Sell, rent or sub-license material from Helper</li>
                    <li>Reproduce, duplicate or copy material from Helper</li>
                    <li>Redistribute content from Helper</li>
                </ul>
                ...
                <p>
                    Helper reserves the right to monitor all Comments and to
                ...
                <p>
                    You hereby grant Helper a non-exclusive license to use,
                ...
                <p>
                    ...
                    compensates the absence of Helper; and (d) the link is in
                ...
                <p>
                    ...
                    inform us by sending an e-mail to Helper. Please include
                ...
                <p>
                    No use of Helper's logo or other artwork will be allowed for
